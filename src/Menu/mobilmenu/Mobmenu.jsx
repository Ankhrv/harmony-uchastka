            ...
            <Sticky enabled={true} >   {/* bottomBoundary={1200} */}
                ...
                <div className="dropdown">
                    ...
                    <div ref={Mennu} className="dropdown-content">
                        ...
                        <NavLink to="/Landshaftnyjdizajn">Ландшафтный дизайн</NavLink>
                        <NavLink to="/landshaftnyj-dizajn">Озеленение и благоустройство</NavLink>
                        <NavLink to="/Rastenya">Растения</NavLink>
                        <NavLink to="/Price">Прайс-лист</NavLink>
                        <NavLink to="/Obslugivaniye">Консервация и обслуживание</NavLink>
                        <NavLink to="/Novinky">Новинки сезона</NavLink>
