...
<ul>
        ...
        <li className={fm.Liclass1}>Посадка деревьев</li>
        <li className={fm.Liclass1}>Рулонный газон</li>
        <li className={fm.Liclass1}>Посевной газон</li>
        <li className={fm.Liclass1}>Искусственный газон</li>
        <li className={fm.Liclass1}>Услуги ландшафтного дизайнера</li>
        <li className={fm.Liclass1}>Ландшафтное проектирование</li>
        <li className={fm.Liclass1}>Монтаж систем автополива</li>
        <li className={fm.Liclass1}>Обслуживание систем автополива</li>
...
<ul>
        ...
        <li className={fm.Liclass1}>Контакты</li>
    </ul>
</div>
<div className={fm.f2div}>
<ul>
        <li className={fm.Liclass}>Личный кабинет</li>
        <li className={fm.Liclass1}>Личный кабинет</li>
