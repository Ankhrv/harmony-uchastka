...
<NavLink to="/Contactsauth" style={{ textDecoration: 'none'}} >   <li className={fm.Liclass1}>Посадка деревьев</li> </NavLink>
<NavLink to="/Contactsauth" style={{ textDecoration: 'none'}} >   <li className={fm.Liclass1}>Рулонный газон</li> </NavLink>
<NavLink to="/Contactsauth" style={{ textDecoration: 'none'}} >   <li className={fm.Liclass1}>Посевной газон</li> </NavLink>
<NavLink to="/Contactsauth" style={{ textDecoration: 'none'}} >   <li className={fm.Liclass1}>Искусственный газон</li> </NavLink>
<NavLink to="/Actionsauth" style={{ textDecoration: 'none'}} >   <li className={fm.Liclass1}>Услуги ландшафтного дизайнера</li> </NavLink>
...
<ul>
                                ...
                                <div className='modal'>
                                    ...
                                    <div className='content'>
                                        ...
                                        <form ref={form} onSubmit={sendEmail} className='te'>
                                            ...
                                            <p className='Ttb'>
                                                Нажимая кнопку "Отправить" вы подтверждаете что ознакомились и согласны с <NavLink className='Tt2' to="/Obrabotkadannyhauth">политикой конфиденциальности</NavLink> </p>
                                        </form>
                                    </div>
                                </div>
                            )
        ...
        <NavLink to="/Contactsauth" style={{ textDecoration: 'none'}} ><li className={fm.Liclass1}>Контакты</li></NavLink>
    </ul>
</div>
<div className={fm.f2div}>
<ul>
